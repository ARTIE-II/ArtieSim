/**
 * @file ArtieIIDICERDetectorConstruction.hh
...
namespace Artie
{
    class ArtieIIDICERDetectorConstruction : public G4VUserDetectorConstruction
    {
    public:
        ArtieIIDICERDetectorConstruction();
        ~ArtieIIDICERDetectorConstruction();

#ifdef ARTIE_YAML
        ArtieIIDICERDetectorConstruction(YAML::Node config);
#endif
    ...
    private:
        ...
        // Detector
        G4Material* mDetectorLeftMaterial;
        G4Material* mDetectorRightMaterial;
        G4Tubs *mSolidDetectorLeft;
        G4Tubs *mSolidDetectorRight;
        G4LogicalVolume* mLogicalDetectorLeft;
        G4LogicalVolume* mLogicalDetectorRight;
        G4VPhysicalVolume* mPhysicalDetectorLeft;
        G4VPhysicalVolume* mPhysicalDetectorRight;
