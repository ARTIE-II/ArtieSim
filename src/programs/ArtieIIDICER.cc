...
int main(int argc, char** argv)
{
    ...
    if(argc == 2) {
        ...
        ConfigFile = "configs/artieII_dicer_ideal_long.yaml";
    }
    else 
    {
    ...
    RunManager->SetUserInitialization(new Artie::ArtieIIDICERDetectorConstruction(Config.GetConfig()));
    RunManager->SetUserInitialization(new Artie::PhysicsList());
    RunManager->SetUserInitialization(new Artie::ArtieIIDICERActionInitialization(Config.GetConfig()));
