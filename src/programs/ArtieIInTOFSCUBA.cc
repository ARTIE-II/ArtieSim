...
int main(int argc, char** argv)
{
    ...
    if(argc == 2) {
        ...
        ConfigFile = "configs/artieII_nTOF_ideal_scuba.yaml";
    }
    else 
    {
    ...
    RunManager->SetUserInitialization(new Artie::ArtieIInTOFSCUBADetectorConstruction(Config.GetConfig()));
    RunManager->SetUserInitialization(new Artie::PhysicsList());
    RunManager->SetUserInitialization(new Artie::ArtieIInTOFActionInitialization(Config.GetConfig()));
